...
from playfair.src.scoring_algorithms import score_weighted_average, score_trigrams_count, score_three_letter_patterns, \
    score_frequencies_english, score_quad_gram_count


def cracking(text_to_crack: str, heuristic, dir_path: str = "playfair/results/", test=False,
             start_key: str | None = None) -> (str, str):
    """
